...
function displayUI(theme, html) {
  ...
  toCsvElement = document.createElement("a");
  toCsvElement.innerText = "csv";
  ...
  toolboxElement.appendChild(toCsvElement);
  ...
  toCsvElement.addEventListener('click', showCsv, false);
